...
const addOne = (arr) => {
  let newArr = [];
  let addArr = (value) => newArr.push(value + 1);
  arr.forEach(addArr);
  return newArr;
};
...
const addExclamation = (arr) => {
  let newArr = [];
  let addExclamation = (value) => newArr.push(value + '!');
  arr.forEach(addExclamation);
  return newArr;
};
...
const allUpperCase = (arr) => {
  let newArr = [];
  let upperCase = (value) => newArr.push(value.toUpperCase());
